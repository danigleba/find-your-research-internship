        ...
        <div className="space-y-6">
          ...
          <div className="flex-box flex-col justify-center w-full space-y-3"> 
            ...
            <div className="flex-box gap-6 w-full md:w-2/3 border border-[#dee1e7] shadow-sm rounded-full px-6 placeholder:text-[#30313D] w-2/3">
              ...
              <input value={search} onChange={(e) => setSearch(e.target.value)} type="text" placeholder="MRNA in situ hybridization..." className="no-ring w-full py-2 placeholder:text-[#dee1e7] focus:outline-none focus:ring-0" />
            </div>
          </div>
          {/*Categories*/}
