    ...
    return (
        <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
                <PostCard name="Steven Pinked" position="Professor" institution="Harvard" department="Math" image="url('/landing/lead1.jpg')"/>
                <PostCard name="Bandy X. Lee" position="Professor" institution="Yale" department="Biology" image="url('/landing/lead2.webp')"/>
                <PostCard name="Emery Brown" position="Professor" institution="MIT" department="Computer Science" image="url('/landing/lead3.jpg')"/>
                <PostCard name="Deborah Archern" position="Professor" institution="NYU" department="Medicine" image="url('/landing/lead4.jpg')"/>
                <PostCard name="Steven Pinked" position="Professor" institution="Harvard" department="Math" image="url('/landing/lead1.jpg')"/>
                <PostCard name="Bandy X. Lee" position="Professor" institution="Yale" department="Biology" image="url('/landing/lead2.webp')"/>
                <PostCard name="Emery Brown" position="Professor" institution="MIT" department="Computer Science" image="url('/landing/lead3.jpg')"/>
                <PostCard name="Deborah Archern" position="Professor" institution="NYU" department="Medicine" image="url('/landing/lead4.jpg')"/>
