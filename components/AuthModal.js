              ...
              <div className="modal-action">
                <form method="dialog" className="flex-box flex-col items-end w-full space-y-6" >
                  ...
                  <div className="flex-box flex-col items-center space-y-3 w-full">
                    <button type="submit" onClick={(e) => checkForm(e, signupData)} className="button-primary w-full">{loading ? "Loading..." : "Sign up"}</button>
            ...
            {authOption == "Login" && (
              <div className="modal-action">
                <form onSubmit={(e) => login(e)} method="dialog" className="flex-box flex-col items-end w-full space-y-6" >
                  ...
                  <div className="flex-box flex-col items-center space-y-3 w-full">
                    <button type="submit" onClick={(e) => checkForm(e, loginData)} className="button-primary w-full">{loading ? "Loading..." : "Log in"}</button>
                    {errors.apiError && <p className="error">{errors.apiError}</p>}
