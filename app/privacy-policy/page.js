                        ...
                        <div className="flex justify-center items-center w-full">
                            <div className="space-y-6 w-full md:w-2/3 ">
                                ...
                                <div>
                                    ...
                                    <p>Email: <a className="underline" href="mailto:joinportiko@gmail.com">joinportiko@gmail.com</a> <br/><br/>For any questions or concerns regarding these Terms of Service, please contact us at the provided email address. <br/><br/> Thank you for using Portiko!</p>
